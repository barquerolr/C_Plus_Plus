/****************************************************************************
* Project 6: Pgm6.cpp - expanding the calculator functions from program 5 with the use of a stack.
*
...
*
* Description: Program will use the same functions as program 5, but will store the answers in a stack.
*
